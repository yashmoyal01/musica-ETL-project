...
def main():
    ...
    process_data(cur, conn, filepath='D:\musica project\song_data', func=process_song_file)
    process_data(cur, conn, filepath='D:\musica project\log_data', func=process_log_file)
